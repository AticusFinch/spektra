          ...
          <div className={styles.descCommunity}>
            <p className={styles.introTextCommunity}>
              {locale === "sr"
                ...
                : "Due to the exceptional importance of the issue of health care for the TIGV community, through this program we actively work on positive changes in this area. Since there are no special services for TIGV people in Montenegro, the only services offered by Spectra within this program are of this type in the country."}
            </p>
